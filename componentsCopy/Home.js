...
import {Card,CardBody,CardTitle,CardText,Button,NavLink,Row,Col,CardImg} from 'reactstrap'
import '../CSS/Home.css'
...
>
        ...
        <div id="footerLink">
        <a className="ancher" href="./">How it Works</a>
        <a className="ancher" href="./Market">For Buyer</a>
        <a className="ancher" href="./Seller">For Seller</a>
        <a className="ancher" href="./">FAQ</a>
        </div>
  </StickyFooter>
  </Fragment>
    )
